...
export function Footer() {
	return (
		<footer className="w-full bg-[#121212] text-white">
			<div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-8 px-5 py-12 sm:px-8 md:flex-row md:items-center md:justify-between md:gap-10 md:py-14">
				<p className="text-center text-base sm:text-lg md:max-w-md md:text-left">
